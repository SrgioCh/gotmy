  ...
  render() {
    ...
    return (
      ...
      <KeyboardAvoidingView behavior="padding" style={{ flex: 1 }}>
        ...
        <View style={{
          flex: this.state.activInput, flexDirection: 'row', paddingTop: '4%',
        ...
        <View style={{ flex: 9 }}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            {/* --------------- BLOQUE MENSAJE A-------------------- */}
            <View style={{
              flex: 1, marginHorizontal: 16, flexDirection: 'row',
              ...
              <View style={{
                ...
                <View style={{ flexDirection: 'row', paddingVertical: 3 }}>
                  <View style={{
                    flex: 6, flexWrap: 'wrap', backgroundColor: '#e2e7ee',
                    paddingVertical: 10, paddingHorizontal: 3, borderRadius: 10
                  }}>
                    <Text style={{
                      fontSize: 14,
                      color: '#312f3d'
                    }}>{this.state.mensajeA}</Text>
                  </View>
            ...
            <View style={{
              ...
              <View style={{
                ...
                <View style={{
                  flex: 6, flexWrap: 'wrap', backgroundColor: '#f6f6f6',
                  paddingVertical: 10, paddingHorizontal: 3, borderRadius: 10
                }}>
                  <Text style={{
                    fontSize: 14,
                    color: '#312f3d'
                  }}>{this.state.mensajeB}</Text>
                </View>

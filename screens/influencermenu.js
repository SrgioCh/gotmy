...
import {
  Alert, StyleSheet, ScrollView, ImageBackground, Image,
...
class InfluencerMenu extends Component {
  ...
  state = {
    ...
    {
      enlace: 'myWalletInfluencer',
      imagmenu: require('../assets/menu/balance.png'),
      titu: 'My Balance',
      borde: null,
    },
    {
      enlace: 'billing', // es otra pagina aun no creada
      imagmenu: require('../assets/menu/billing.png'),
      titu: 'Billing',
      borde: styles.bordeFinal,
    },
    {
      enlace: 'settings', // es otra pagina aun no creada

...
import {
  Platform, StyleSheet, Text, TextInput, View, ScrollView, Dimensions,
      ...
      <KeyboardAvoidingView behavior="padding" style={{ flex: 1 }}>
        ...
        <View style={{
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={{
              flex: 1, flexDirection: 'row', paddingBottom: Platform.OS === 'ios' ? hp('4%') : '3%',
            ...
            <View style={{ flexDirection: 'row', paddingVertical: hp('1.5%'), marginHorizontal: '4%' }}>
            ...
            <View style={{ alignItems: 'center', marginTop: hp('5%') }}>
              ...
              <TouchableOpacity style={styles.containerbutton}
                onPress={() => this.props.navigation.navigate("becomeInfluencerStep6")}
              >

           ...
           <View style={{flex:2,marginHorizontal:'4%',flexDirection:'row'}}>
                <View style={{flex:3.5}}>
                      ...
                      <View style={{flex:6,justifyContent:'center'}}>
                            <View style={{borderRadius:27 ,borderWidth:1,borderColor:'#e2e7ee',paddingVertical:hp('1%'),
                                       width:'95%',flexDirection:'row',paddingLeft:wp('2%')}}>
                                ...
                                <TextInput
                                   ...
                                   keyboardType='numeric'
                                    style={{
                                     ...
                                     paddingLeft: Platform.OS === 'ios' ? 12:wp('2%'),
                                     }}
                ...
                <View style={{flex:6.5,paddingLeft:'4%'}}>
                <View style={{flex:4,justifyContent:'flex-end'}}>
                      ...
                      <View style={{flex:6,justifyContent:'center'}}>
                            <View style={{borderRadius:27 ,borderWidth:1,borderColor:'#e2e7ee',paddingVertical:hp('1%'),
                                       width:'50%',flexDirection:'row',paddingLeft:wp('3%')}}>
                                
                                 <Image source={require('../assets/icons_genGMI/Time.png')} 
                                 style={{ width:23,height:23,marginTop:hp('0.4%')}}
                                  /> 

      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1.5, alignItems: 'center', paddingHorizontal: wp('17%') }}>
          <Text style={{
            ...
            Explain to INFLUENCER what is the sending of a new proposal for a private metting different from that requested by VIEWER in your request  </Text>


        </View>
        <View style={{ flex: 1, alignItems: 'center' }}>
          <TouchableOpacity style={styles.containerbutton}
            onPress={() => this.props.navigation.navigate("meetingProposal2")}
          >

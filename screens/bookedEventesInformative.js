      ...
      <View style={{ flex: 1 }}>
          ...
          <ScrollView>
            <View style={{
              ...
              <View style={{ backgroundColor: '#f6f6f6', paddingBottom: 7 }}>
                ...
                {/* cajita fecha*/}
                <View style={{
                  borderRadius: 10, marginTop: Platform.OS === 'ios' ? null : -9,
              ...
              <View style={{
                paddingBottom: 10, marginHorizontal: 16,
        ...
        for something different to happen.</Text>
              ...
              <View style={{ flexDirection: 'row', marginHorizontal: 16, marginVertical: 14 }}>
                ...
                <View style={{
                  flex: 5, flexDirection: 'column', paddingLeft: 10,
        ...
        <View style={{
          flex: 1, backgroundColor: '#ff5a60', flexDirection: 'row'
        }}>

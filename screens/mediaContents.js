      ...
      usuarios:[
        {
         ...
         imagVideo:require('../assets/OnBoard/fitness.jpg'),
         duraVid:'12:40',
         tipo:'Sports'
        ...
        },
        {
          fecha:'Monday, 19/12/2018',
         descripcion:'Teaching Machamp THE BEST MOVE IN THE GAME' ,
         imagVideo:require('../assets/OnBoard/podcast.jpg'),
         duraVid:'12:40',
        ...
        },
        {
          fecha:'Monday, 19/12/2018',
         descripcion:'Teaching Machamp THE BEST MOVE IN THE GAME' ,
         imagVideo:require('../assets/OnBoard/tecnologia.jpg'),
         duraVid:'12:40',
         tipo:'Naturs,Outdoors & Chefs'
        }
        ,
        {
          fecha:'Monday, 19/12/2018',
         descripcion:'Teaching Machamp THE BEST MOVE IN THE GAME' ,
         imagVideo:require('../assets/OnBoard/fashion.jpg'),
         duraVid:'12:40',
         tipo:'Naturs,Outdoors & Chefs'
        }

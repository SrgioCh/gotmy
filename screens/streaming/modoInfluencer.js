         ...
         onPress={Keyboard.dismiss} accessible={false}>
           ...
           <TouchableOpacity
                    ...
                    <View style={{display:this.state.disfotInicio}}>
                         ...
                         <View  style={{paddingHorizontal:hp('3.5%'),paddingVertical:hp('3.5%'),backgroundColor:'black',opacity:0.5,zIndex:1,
                             borderRadius:Platform.OS === 'ios' ? 23:30,borderColor:'grey',borderWidth:wp('0.5%')}} >
                         ...
                         <Image source={this.state.imagModerador} 
                             style={{ width:50,height:50,zIndex:3,borderRadius:30}}
                               /> 
                         </View>
                             ...
                             <View style={{flex:1,flexDirection:'row'}}>
                                 <View style={{flex:4,justifyContent:'center'}}>
                                   <View  style={{flexDirection:'row'}}>
                                     <Image source={require('../../assets/influencers/spffiele.png')} 
                                      style={{width:50,height:48,borderRadius:30,zIndex:3}}
                                        /> 
                                        <Image source={require('../../assets/usuarios/userc.png')} 
                                      style={{width:50,height:48,borderRadius:30,marginLeft:wp('-5%'),zIndex:2}}
                                        /> 
                                        <Image source={require('../../assets/usuarios/usera.png')} 
                                      style={{width:50,height:48,borderRadius:30,marginLeft:wp('-5%'),zIndex:1}}
                                        /> 

      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 8.7 }}>
          ...
          <ScrollView ref='scrol'
            horizontal
            scrollEnabled={this.state.princi}
            pagingEnabled={true}
            onScroll={
              (event) => {
                        ...
                        return (
                          <View key={i} style={{ marginLeft: wp('3%') }}>
                            ...
                            <View style={{ backgroundColor: '#f6f6f6', borderRadius: hp('2.5%'), height: Platform.OS === 'ios' ? hp('39%') : hp('40.5%') }}>
                              ...
                              {/* cajita fecha*/}
                              <View style={{
                                marginTop: hp('-1.5%'), marginHorizontal: wp('2%'),
                                /*      marginLeft:  Platform.OS === 'ios' ? 6:8,
                                  marginRight:  Platform.OS === 'ios' ? 11:8,*/
                                flexDirection: 'row'
                              }}>
                                <View style={{
                                  flex: 1.5, borderBottomLeftRadius: hp('2.5%'), flexDirection: 'column',
                                ...
                                <View style={{ flex: 8.5, flexDirection: 'column', backgroundColor: 'white', paddingBottom: hp('2%'), borderBottomEndRadius: hp('2.5%') }}>
                                  <Text style={{
                                    fontSize: Platform.OS === 'ios' ? 15 : wp('4%'),
                                    fontWeight: 'bold', color: '#312f3d', marginTop: hp('1%')
                                  }}>
                                    {item.texto1}</Text>

                                  <Text style={{
                                    fontSize: Platform.OS === 'ios' ? 14 : wp('3.3%'),
                                  ...
                                  <View style={{ flexDirection: 'row', paddingTop: hp('0.5%') }}>
                                    ...
                                    <Text style={{
                                      fontSize: Platform.OS === 'ios' ? 11 : wp('3%'),

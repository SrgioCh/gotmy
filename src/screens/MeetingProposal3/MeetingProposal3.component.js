...
export default class MeetingProposal3 extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            nameInflu: 'Sophia Lindsey',
            ciudad: 'Luxemburgo',
            iconLocation: require('../../../assets/icons_genGMI/ubicacion.png'),
                            ...
                            <View style={{ flex: 6, }}>
                                <View style={{ flexDirection: 'row' }}>
                                    <View style={{ justifyContent: 'center' }}>
                                        <Image
                                            source={this.state.iconLocation}
                                            style={{ width: 10, height: 10 }}
                                        />
                                    </View>
                                    <View style={{ justifyContent: 'center', marginLeft: wp('1%') }}>
                                        <Text style={styles.textGrey}>{this.state.ciudad}</Text>
                                    </View>
                    ...
                    <View style={{
                        ...
                        >
                            <Text style={{ color: '#ff5a60', fontSize: wp('4.5%') }}>
                                Cancel Private Meeting Proposal</Text>
                        </TouchableOpacity>
                    </View>

                    <View style={{
                        height: hp('10%'), marginBottom: '2%',
                        justifyContent: 'center', alignItems: 'center',
                    }}>
                        <TouchableOpacity style={styles.containerbutton2}
                            onPress={() => this.props.navigation.navigate("meetingProposal5")}

                        >
                            <Text style={{ color: '#ff5a60', fontSize: wp('4.5%') }}>
                                Edit your proposal</Text>
                        </TouchableOpacity>
                    </View>

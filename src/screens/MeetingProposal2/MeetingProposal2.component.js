...
import styles from './MeetingProposal2.style';

export default class MeetingProposal2 extends Component {
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ paddingBottom: hp('2%') }}>
                        ...
                        <View style={{
                            ...
                            <TouchableOpacity style={styles.containerbutton}
                                onPress={() => this.props.navigation.navigate("meetingProposal3")}

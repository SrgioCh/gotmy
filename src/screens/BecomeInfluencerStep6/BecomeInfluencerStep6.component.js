...
import styles from "./BecomeInfluencerStep6.style"


export default class BecomeInfluencerStep6 extends Component {

    static navigationOptions = {
        headerTitle: 'Choose your categories',
        headerTitleStyle: {
            alignSelf: 'center',
            textAlign: 'center',
                    ...
                    <ScrollView contentContainerStyle={{ marginHorizontal: '4%' }}>
                        ...
                        <View style={styles.filas}>
                            <TouchableOpacity
                                ...
                                onPress={
                                    () => this.props.navigation.navigate("becomeInfluencer7")
                                }
                            >

...
export default class EventContents extends React.Component {
    ...
    return (
     <View style={{marginTop:hp('1.5%')}}>
         ...
         <View style={{flexDirection:'row'}}>
               <View style={{flex:6.5}}>
                   <View style={{}}>
                        <Text style={{color:'#677183',fontSize:wp('3.5%')}}>{this.props.fecha}</Text>
                     </View>
                     <View style={{paddingRight:'10%',paddingVertical:'2%'}}>
                        <Text style={styles.textTren}>{this.props.descripcion}</Text>
                     </View>
                     <View>
                     <Text style={{color:'#ff5a60',fontSize:wp('4%')}}>{this.props.tipo}</Text>
                     </View>
                </View>
